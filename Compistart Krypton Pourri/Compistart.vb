...
Public Class Compistart
    ...
    Public fichier_a_importer As String = ""
...
"%[PARAM_ADMIN.END]%"
    ...
    'Fonction label8_Click
    Public Sub label8_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles label8.Click
    End Sub
    ...
    'Fonction numericUpDown6_ValueChanged
    Public Sub numericUpDown6_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles numericUpDown6.ValueChanged
    End Sub
    ...
    'Fonction tabPage2_TabIndexChanged
    Public Sub tabPage2_TabIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tabPage2.TabIndexChanged
    End Sub

    'Fonction tabPage3_TabIndexChanged
    Public Sub tabPage3_TabIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tabPage3.TabIndexChanged
    End Sub
        ...
        For Each ligne As String In lignes
            ...
            ElseIf dansSection Then
                If ligne.StartsWith(nomParam & "=") Then
                    Return ligne.Substring((nomParam & "=").Length)
                End If
            End If
        Next
    ...
    Sub ModifierParametre(section As String, nomParam As String, valeur As String)
        Dim debutTag As String = "%[" & section & "]%"
        Dim finTag As String = "%[" & section & ".END]%"
        Dim lignes() As String = fichiercache.Split({vbCrLf}, StringSplitOptions.None)
        ...
        If debutIndex = -1 Or finIndex = -1 Or debutIndex >= finIndex Then
            Exit Sub ' Section non trouvée ou mal formée
        End If

        Dim paramTrouve As Boolean = False
        For i As Integer = debutIndex + 1 To finIndex - 1
            If lignes(i).StartsWith(nomParam & "=") Then
                lignes(i) = nomParam & "=" & valeur
                paramTrouve = True
                Exit For
            End If
        Next

        If Not paramTrouve Then
            ' Ajoute le paramètre juste avant la balise de fin
            Dim liste As New List(Of String)(lignes)
            liste.Insert(finIndex, nomParam & "=" & valeur)
